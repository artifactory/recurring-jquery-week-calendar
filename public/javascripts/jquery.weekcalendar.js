...
(function($) {
  ...
  $.widget('ui.weekCalendar', (function() {
    ...
    return {
      options: {
        date: new Date("January 2, 2000 9:00"),   // "January 2, 2000"        
        timeFormat: null,
        dateFormat: 'M d, Y',
         ...
         * @type {array}
         */
        // users: ["Aggy Aardvark", "Mr. Wonderful", "Master of Illusion", "Rembrandt Fish", "Oh Solo Mio", "Carnivorous Physician"],
        // users: ["Aggy Aardvark"],
        /**
      ...
      today: function() {
        this._clearCalendar();
        this._loadCalEvents(new Date("January 2, 2000"));
      },
      ...
      getCurrentFirstDay: function() {
        return this._dateFirstDayOfWeek(this.options.date || new Date("January 2, 2000"));
      },
...
//              calendarHeaderHtml+=    "</div>";
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
          ...
          if (typeof options.data == 'string') {
            ...
            _currentAjaxCall = $.ajax({
              ...
              error: function(XMLHttpRequest, textStatus, errorThrown) {
                ...
                // fixes #55
                // if (errorThrown != 'abort' && XMLHttpRequest.status != 0  &&  XMLHttpRequest.status != 200) {
      ...
      _isToday: function(date) {
          ...
          var today = new Date("January 2, 2000");
      ...
      _getHeaderDate: function(date) {
        ...
        // TC - we don;t want dates on rev1.
